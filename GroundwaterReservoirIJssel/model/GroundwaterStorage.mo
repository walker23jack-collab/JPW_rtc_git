...
// River-aquifer interaction according to Darcy's leakage concept
  ...
  annotation(
    Diagram(graphics = {Text(origin = {-67, -24}, extent = {{1, 0}, {-1, 0}}, textString = "River intake"), Text(origin = {-73, 32}, extent = {{-15, 6}, {15, -6}}, textString = "River intake"), Text(origin = {-27, 61}, extent = {{-33, 11}, {33, -11}}, textString = "Natural groundwater recharge"), Text(origin = {70, 11}, extent = {{-20, 11}, {20, -11}}, textString = "River aquifer interaction"), Text(origin = {68, 37}, extent = {{-20, 11}, {20, -11}}, textString = "Groundwater extraction"), Text(origin = {117, 19}, extent = {{-199, -35}, {-145, -21}}, textString = "Groundwater base flow")}));
